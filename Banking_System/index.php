...
<head>
    ...
    <style type="text/css">
        ...
        button{
            ...
            background-image: linear-gradient(315deg, lightblue 50%, #00ccff 50%);
        }
        h1 {
  ...
  <br>
    <div class="container-fluid">
        ...
        <div class="intro py-1">
            <div >
                <div >
                   <center><b><h1 style="background: #4dd2ff;"><img src="img\bankicon.png" style="height: 13%; width:10%"><br>THE SPARKS BANK</h1></b></center>
                </div>
            </div>
    ...
    <footer class="text-center mt-5 py-2">
        <p>Made by <b>Syed Nahid</b> &copy 2021.</p>
